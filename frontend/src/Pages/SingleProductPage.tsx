...
useEffect(()=>{
  axios.get(`https://precious-n-charms.onrender.com/products/${id}`).then((res)=>{
...
console.log(isPrasent,"ISPresent")
  try {
   ...
   let res= await axios.put(`https://precious-n-charms.onrender.com/users/${userId}`, updatedUser);
