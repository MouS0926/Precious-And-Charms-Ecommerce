...
const loginuserdetails=useSelector((store:any)=>store.authReducer.ActiveUser);
...
if(loginuserdetails)
{
  usercart=loginuserdetails.addToCart.length
}
...
{isAuth?(
          ...
          >
            ...
            <a style={{"color":"#f7946a","padding":"3px"}}>{name}</a> 
